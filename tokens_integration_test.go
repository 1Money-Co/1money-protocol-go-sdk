...
func TestGrantMasterMintAuthority(t *testing.T) {
	...
	payload := TokenAuthorityPayload{
		...
		Nonce:            nonce,
		Action:           AuthorityActionGrant,
		AuthorityType:    AuthorityTypeMasterMintBurn,
		AuthorityAddress: common.HexToAddress(TestOperatorAddress),
		Token:            common.HexToAddress(TestTokenAddress),
		Value:            big.NewInt(1500000),
	}
...
func TestBlacklist(t *testing.T) {
	...
	payload := TokenManageListPayload{
		...
		Address:          common.HexToAddress(BlacklistAddress),
		Token:            common.HexToAddress(TestTokenAddress),
	}
	// Sign the payload
	signature, err := client.SignMessage(payload, TestOperatorPrivateKey)
